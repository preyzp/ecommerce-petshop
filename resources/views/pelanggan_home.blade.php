...
<body>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="ogani/img/hero/banner.jpg">
                        <div class="hero__text">
                            <span>Selamat Datang {{ \Auth::guard('pelanggan')->user()->nama }}</span>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Login Admin <a href="{{ url('login') }}" >Login</a>
